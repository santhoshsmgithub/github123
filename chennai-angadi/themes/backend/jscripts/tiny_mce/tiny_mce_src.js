...
(function(tinymce) {
	...
	tinymce.html.Schema = function(settings) {
		...
		if (!settings.valid_elements) {
			...
			each(split('p,ol,ul,sub,sup,blockquote,span,font,a,table,tbody,tr,strong,b'), function(name) {
				if (elements[name]) {
			...
			each(split('h1,h2,h3,h4,h5,h6,th,td,pre,address,caption'), function(name) {
	...
	tinymce.create('tinymce.ui.Button:tinymce.ui.Control', {
		...
		renderHTML : function() {
			...
			if (s.image && !(this.editor  &&this.editor.forcedHighContrastMode) )
				h += '<span class="mceIcon ' + s['class'] + '"><img class="mceIcon" src="head/' + s.image + '" alt="' + DOM.encode(s.title) + '" /></span>' + (l ? '<span class="' + cp + 'Label">' + l + '</span>' : '');
			else
