...
class CI_Email {
	...
	var	$smtp_host		= "mail.chennaiangadi.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "test@chennaiangadi.com";		// SMTP Username
	var	$smtp_pass		= "Adminpwd@123";		// SMTP Password
