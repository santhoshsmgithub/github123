        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content"> 
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 20px 20px 0 20px; border-bottom: 1px solid #f6f6f6; color: #555555; font-family: Arial, sans-serif; font-size: 15px; line-height: 24px;">                    
                     <?php echo "Dear ".$name.",<br>Thank you for registering with us.<br>Please click on below URL or paste into your browser to verify your Email Address:<br> ".$this->config->item('base_url')."cart/verify/".$session_id."<br><br>Thanks<br>Admin Team"; ?>
                </td>
            </tr>  
            <tr>
                <td align="center" bgcolor="#fca800" style="padding: 15px 10px 15px 10px; color: #fff; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px;">
                    <b>Chennai angadi,</b><br/> New no 15, Old no 8, Muthu Street, Mylapore, Chennai - 60004
                </td>
            </tr> 
        </table> 
    </body>
