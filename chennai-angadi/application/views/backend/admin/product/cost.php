  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Products Cost</a> </li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>List  - <span class="semi-bold">Products Cost</span>  <a href="<?php echo $base_url ;?>manage/addproduct"> <button class="btn btn-info" value="Add Menu" >Add Product</button></a></h3></h3>
      </div>
              ...
              <div class="row-fluid">
                <table class="table table-hover table-condensed" id="example">
				  ...
				  <td valign="middle"><a  target="_new" href="<?php echo  $base_url. "product/".$products_info->product_image;?>"><img src="<?php echo  $base_url. "product/".$products_info->product_image;?>" width="75" height="30" alt="" /></a></td>  	
					...
					<td valign="middle"><?php echo $products_info->prod_weight;?></td>
					<!--<td valign="middle"><?php echo $products_info->prod_ret_amt;?></td>
					<td valign="middle"><?php echo $products_info->prod_off_amt;?></td>
                     <td><?php  if($products_info->discount_status==1) {?>    
								<button  Placeid="<?php echo $products_info->id;?>"   action='1' class="btn btn-mini btn-success status-btn">Yes</button>
								<?php  } else { ?>
								<button Placeid="<?php echo $products_info->id;?>" action='0' class="btn btn-mini btn-danger status-btn">No</button>
								<?php } ?>
								</td>  -->    
					 <td><?php  if($products_info->status==1) {?>    
                      ...
                      <!--<td valign="middle">
								<?php echo anchor($base_url.'manage/editstockcost/'.$products_info->product_id,'<i class="icon-pencil"></i>'); ?>
