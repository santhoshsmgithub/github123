...
if (isset($subCategory)) {
	$mainCatId = $subCategory->main_category;
  ...
  <div class="page-content">
    ...
    <div class="content">
      ...
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Form - <span class="semi-bold">Add sub Category</span></h3>
      </div>
					...
					<form  class="form-no-horizontal-spacing"   id="addform"  name="rentform"   method="post" enctype="multipart/form-data">	
						<div class="row-fluid column-seperation">
							<div class="span12">
								...
								<div class="row-fluid">
									<div class="span2">	<label>Category Name</label>	</div>
									<div class="span5">
										<select name="main_category" id="state_id"  data-placeholder="Choose a Ownership  ..." class="span12 validate[required]">
											<option value="">---Select Category----</option>
											<?php foreach($category as $category_info) { ?>
											<option <?php if($category_info->id==$mainCatId){ echo "selected"; }else{} ?> value="<?php echo $category_info->id;?>"><?php echo $category_info->category_title;?></option>
											<?php } ?>
										</select>
									</div>
								</div>
