  ...
  <div class="page-content">
    ...
    <div class="content">
      ...
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>List  - <span class="semi-bold">sub Category</span>  <a href="<?php echo $base_url ;?>admin/sub-category/add"> <button class="btn btn-info" value="Add Menu" >Add sub Category</button></a></h3></h3>
      </div>
        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>sub Category<span class="semi-bold"></span>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td valign="middle"><?php echo $category_info->id;?></td>
					   ...
					   $this->db->where("id", $category_info->main_category);
					   $category=$this->db->get("category")->row();
					  echo isset($category) ? $category->category_title: "" ;
					   ?></td>
					 ...
					 <td><?php  if($category_info->status==1) {?>    
                      ...
                      <td valign="middle">
								<?php echo anchor($base_url.'admin/sub-category/add/'.$category_info->id,'<i class="icon-pencil"></i>'); ?>
								<?php echo anchor($base_url.'admin/sub-category/delete/'.$category_info->id,'<i class="icon-trash"></i></a>'); ?>
