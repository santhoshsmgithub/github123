  ...
  <div class="page-content">
    ...
    <div class="content">
      ...
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>List  - <span class="semi-bold">Slider</span>  <a href="<?php echo $base_url ;?>admin/slider/add"> <button class="btn btn-info" value="Add Menu" >Add Slider</button></a></h3></h3>
      </div>
      <div class="row-fluid">
        <div class="span12">
                ...
                <table class="table table-hover table-condensed" id="example">
                  ...
                  <tbody>
						...
						if(!empty($slider)) { 
							...
							foreach($slider as $products_info) {
							$l++; ?>
                    <tr>
                      ...
                      <td valign="middle"><?php echo $products_info->id;?></td>
					   <td valign="middle"><?php echo $products_info->slider_link;?></td>
                     <!-- <td valign="middle"><?php echo $products_info->slider_tag;?></td>-->
  <td valign="middle"><a  target="_new" href="<?php echo  $base_url. "slider/".$products_info->slider_image;?>"><img src="<?php echo  $base_url. "slider/".$products_info->slider_image;?>" width="75" height="30" alt="" /></a></td>  
<!--  <td valign="middle"><a  target="_new" href="<?php echo  $base_url. "slider/".$products_info->slider_small_image;?>"><img src="<?php echo  $base_url. "slider/".$products_info->slider_small_image;?>" width="75" height="30" alt="" /></a></td> --> 
					 <td><?php  if($products_info->status==1) {?>    
                      ...
                      <td valign="middle">
								<?php echo anchor($base_url.'admin/slider/add/'.$products_info->id,'<i class="icon-pencil"></i>'); ?>
					  		<a href="<?php echo $base_url;?>admin/slider/delete/<?php echo $products_info->id;?>" onclick="return confirm('Are you sure you want to delete this <?php echo $products_info->id;?>?');" class=""><i class="icon-trash"></i></a>
