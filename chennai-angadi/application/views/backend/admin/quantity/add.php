...
$name = $orderBy = $status = $yes = $no="";

if (isset($quantity)) {
	$name = $quantity->quantity_name;
	$orderBy = $quantity->order_by;
  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active"> Add quantity</a> </li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Form - <span class="semi-bold">Add quantity</span></h3>
      </div>
					...
					<form  class="form-no-horizontal-spacing"   id="addform"  name="rentform"    method="post" enctype="multipart/form-data">	
						<div class="row-fluid column-seperation">
							<div class="span12">
								<h3>Quantity Info </h3>
								<div class="row-fluid">
									<div class="span2">	<label>Quantity Name</label>	</div>
									<div class="span5">
										<input class="span12  validate[required]" type="text" name="quantity_name" value="<?php echo $name;?>"  />
									</div>
								</div>
								<div class="row-fluid">
								...
								<div class="row-fluid row-fluid-status">
									...
									<div class="span8">
										<div class="radio">
											<input type="radio" checked="checked" value="1" name="status" id="amt_status_yes" value="<?php echo $yes;?>">
											<label for="amt_status_yes">Approved</label>
											<input type="radio" value="0" name="status" id="amt_status_no" value="<?php echo $no;?>">
