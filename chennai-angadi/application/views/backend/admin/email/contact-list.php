  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">Contact Email</a> </li>
      </ul>
        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h4>Contact Email<span class="semi-bold"></span>
                ...
                <table class="table table-hover table-condensed" id="example">
                  ...
                  <tbody>
                    ...
                    <tr>
					  ...
					  <td valign="middle"><?php echo $email_info->name;?></td>
					   <td valign="middle"><?php echo $email_info->email;?></td>
					   <td valign="middle"><?php echo $email_info->phone;?></td>
                      <td valign="middle"><?php echo $email_info->message;?></td>
                      <td valign="middle">
								<?php echo anchor($base_url.'manage/deleteconemail/'.$email_info->id,'<i class="icon-trash"></i></a>'); ?>
					  </td>
                    </tr>
            <?php } } ?>
