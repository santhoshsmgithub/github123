  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active"> Edit Password</a> </li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Form - <span class="semi-bold">Edit Password</span></h3>
      </div>
	...
	<div class="row-fluid">
        <div class="span12">
          <div class="grid simple">
			...
			<form class="form-no-horizontal-spacing edit-userform rentform"  id="addform"   name="rentform"  action="<?php echo $this->config->item('base_url');?>admin/change-password/<?php echo $this->session->userdata('User_ID');?>"   method="post" >
              <div class="row-fluid column-seperation">
                <div class="span12">
				     ...
				     <div class="row-fluid">
                      ...
                      <div class="span5">
                  	   	<input type="password" name="user_identity" id="password" class=" input-xlarge  validate[required]" value=""/ />
                      </div>
                  </div>
				   ...
				   <div class="row-fluid">
                      ...
                      <div class="span5">
                  	    <input type="password"  class="input-xlarge  validate[required,equals[password]]" value=""/ />
                      </div>
                  </div>
